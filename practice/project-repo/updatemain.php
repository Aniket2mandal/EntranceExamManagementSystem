    ...
    <div class="main">
        ...
        <div class="log">
           ...
           <div class="reg"><p>UPDATE</p></div><br>
            <!-- Firstname: -->
            <input type="text"required id="fnam" required name="nam" placeholder="Firstname"><br><br>
            <!-- Lastname: -->
            <input type="text" required id="lname" required name="lnam" placeholder="lastname"><br><br>
            <!-- Email:<br> -->
            <input type="email" required id="emai" required name="emii" placeholder="Email"><br><br>
            <!-- Password:<br>
