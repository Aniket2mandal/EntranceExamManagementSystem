...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $_SESSION['newid']=$id;
$sqlf=mysqli_query($connection,"SELECT `firstname` FROM `login` WHERE `id`='$id'");
$sqll=mysqli_query($connection,"SELECT `lastname` FROM `login` WHERE `id`='$id'");
$sqle=mysqli_query($connection,"SELECT `email` FROM `login` WHERE `id`='$id'");
$row=mysqli_num_rows($sqlf);
if($row>0){
    $rataf=implode(mysqli_fetch_assoc($sqlf));
    $_SESSION['firstname']=$rataf;
    $ratal=implode(mysqli_fetch_assoc($sqll));
    $_SESSION['lastname']=$ratal;
    $ratae=implode(mysqli_fetch_assoc($sqle));
    $_SESSION['email']=$ratae;
}
}
if ($userprofile == true) {
} else {
...
<body>
    <div class="nav">
        ...
        <ul>
            ...
            <li class="drop">
                <button class="exambtn"style="color:#ffb20b">ROUTINE</button>
                <div class="exam">
            ...
            <li class="drop2">
                <button class="dropbutton"style="color:#ffb20b">RESULT</button>
                <div class="result">
                    <!-- <a href="loksewa.html">LOKSEWA</a> -->
...
<div class="maincontent">
        <div class="admin">
            <h1 style="color:orange">Admin Page</h1>
        </div>
        ...
        <!-- FORM -->
        <div class="form">
            <p style="color:red;margin-top:5px;text-align:center;font-weight:bolder;">
            <?php
             echo $_SESSION['error'];
            ...
            <form action="edituser.php" method="post" onsubmit="return confirm('Are you sure you want to update?');">
                ...
                <!-- Firstname: -->
                <input type="text" required id="fnam" required name="fnam" value="<?php echo $_SESSION['firstname'] ?>"><br><br>
                <!-- Lastname: -->
                <input type="text" required id="lnam" required name="lnam" value="<?php echo $_SESSION['lastname'] ?>"><br><br>
                <!-- Email:<br> -->
