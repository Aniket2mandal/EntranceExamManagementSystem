...
<html>
    ...
    <link rel="stylesheet" href="IOM.css">
    <body>
        <div class="nav">
            <!-- <img src="LOGO.png"> -->
...
<?php 
          ...
          if (mysqli_num_rows($res) > 0) {
             ...
             <div class="alb">
             	<img src="uploads/<?php echo $images['routine']?>">
             </div>
