...
<!-- FORM -->
<div class="form">
<form action="updateroutine.php" method="post"  enctype="multipart/form-data">
...
<select name="Identity" id="identify">
    ...
    Enter the new file of routine:<br>
    <input type="file"   name="my_image"><br><br>
    <input type="hidden" name="oldimg" value="<?php echo $images['routine'] ?>">
        <!-- TO DELETE IMAGES -->
