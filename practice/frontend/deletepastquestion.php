...
<div class="maincontent">
        ...
        <div class="form">
            ...
            <p style="color:red;margin-top:5px;text-align:center;font-weight:bolder;"><?php
                                                                                        echo $_SESSION['error'];
...
<select name="Identity" id="identify">
    ...
    <button type="submit" class=btn1>ADD RESULT</button><br><br>
            ...
            <form action="deletequestion.php" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to submit?');">
                <select name="Identity" id="identify">
                    <option value="IOM">IOM</option>
                    <option value="IOE">IOE</option>
                </select><br><br>
                ...
                <button type="submit" class=btn1>DELETE QUESTION</button><br><br>
            </form>
            <!-- TO DELETE IMAGES -->
            <!-- <div class="deup">
